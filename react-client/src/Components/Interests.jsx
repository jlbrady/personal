    ...
    return (
      <div className="top">
        <div className="about">
          ...
          <h3 style={{textAlign: 'center'}}>I am currently studying Computer Science at the University of Michigan and finishing my final semester. 
          I enjoy working with both front and back end systems and learning more about computer networks and cyber security.
