...
class NavBar extends Component {
  render() {
    return (
      <header>
        <ul id="headerButtons">
          <li className="navButton" onClick={() => scrollToComponent(this.About1, { offset: 0, align: 'top', duration: 1500})}><img src="//upload.wikimedia.org/wikipedia/commons/3/36/Michigan_Wolverines_Block_M.png"/></li>
