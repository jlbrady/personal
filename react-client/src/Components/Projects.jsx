    ...
    return (
      <div>
        ...
        <div id="info">
          ...
          <h4>This Website!</h4>
          <p style={{paddingBottom: '0.5%'}}>While working in Ann Arbor this past summer I decided to build a website.  My job did not involve as much coding as I would have liked so I decided to take on a side project utilizing some of the skills I had learned that previous semester in my Web Systems course.  The website is built using <em>React, Express,</em> and <em>Webpack</em>, with a bit of <em>Bootstrap CSS</em> for style.  It is hosted via <em>Amazon's S3 storage system</em> and <em>Route 53 cloud DNS service</em>.  Content delivery is provided by <em>Amazon's CloudFront</em>.  Overall I am happy with the outcome of the project and glad that it has allowed me to touch up on some of my coding skills while learning some of the intracacies of Amazon's cloud computing servives.</p>
          <h4>CodeHop, an iOS app to prepare for coding interviews on the go!</h4>
          <p>For our <em>mobile app development for entrepreneurs</em> class our team developed an iOS app to practice studying for coding interviews on the go.  The app is designed to help students quiz themselves on topics commonly covered in technical coding interviews; such as data structures, algorithms, and time complexities.  Main features include instant feedback and answer explanations.  Within one month of uploading to the <em>Apple App Store the app recieved 130+ downloads from 10 different countries</em>.  Throughout the coming semester I plan to continue developing the app by adding new features and content.</p>
          ...
          <p style={{paddingBottom: '3%'}}>Throughout the internship I led the effort to establish an e-commerce platform from scratch for a new division
            ...
            provide a seamless user experience for our clients.  Currently the online storefront handles over $1 MM+ in annual sales.</p>
        </div>
      </div>
    )
  }
